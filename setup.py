...
REQUIRED_PKG = ['numpy','scipy','pandas','statsmodels','tqdm','xlrd','matplotlib','seaborn'] # indicate required packages

with open("README.md", "r") as fh:
    long_description = fh.read()

setup(
    name='statutil', # add the package name
    version=__version__,
    description="a package for statistic utility", # add short description
    long_description=long_description,
    long_description_content_type='text/markdown',
    url='https://github.com/mizuno-group',
    author='tadahaya', # add your name
